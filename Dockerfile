...
#
#   docker build -t ipie-communication-service .
#
# It was a Gradle module until then, which is why this file used to require the monorepo root as
# context and a module-qualified :ipie-communication-service:bootJar task.
...
COPY --from=build /workspace/build/libs/ipie-communication-service.jar app.jar
