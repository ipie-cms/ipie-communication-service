 ...
 * {@link UserRegistrationCompletedConsumer}'s shape exactly (matches the only broker
...
class UserLoggedInConsumer {
    ...
    private static final Logger LOG = LoggerFactory.getLogger(UserLoggedInConsumer.class);

    private final NotificationService notificationService;
    private final ProcessedEventStore processedEventStore;

    UserLoggedInConsumer(NotificationService notificationService, ProcessedEventStore processedEventStore) {
    ...
    void onUserLoggedIn(EventEnvelope<UserLoggedInPayload> event) {
