...
class UserRegistrationCompletedConsumer {

    private static final Logger LOG = LoggerFactory.getLogger(UserRegistrationCompletedConsumer.class);

    private final NotificationService notificationService;
    private final ProcessedEventStore processedEventStore;

    UserRegistrationCompletedConsumer(NotificationService notificationService, ProcessedEventStore processedEventStore) {
    ...
    void onUserRegistrationCompleted(EventEnvelope<UserRegistrationCompletedPayload> event) {
