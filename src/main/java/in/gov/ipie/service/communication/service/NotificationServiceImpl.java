...
import in.gov.ipie.service.communication.event.AccountCredentialSetupRequestedPayload;
...
import in.gov.ipie.service.communication.event.UserRegistrationCompletedPayload;
...
public class NotificationServiceImpl implements NotificationService {
    ...
    @Override
    public void sendCredentialSetupLink(AccountCredentialSetupRequestedPayload event) {
    ...
    @Override
    public void sendVerificationRequest(UserRegistrationCompletedPayload event) {
    ...
    @Override
    public void sendEmailOtp(RegistrationEmailOtpPayload event) {
    ...
    @Override
    public void sendRegistrationReceivedNotification(UserRegistrationCompletedPayload event) {
    ...
    @Override
    public void sendLoginNotification(UserLoggedInPayload event) {
