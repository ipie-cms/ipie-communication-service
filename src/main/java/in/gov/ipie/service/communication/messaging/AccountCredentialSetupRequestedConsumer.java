...
class AccountCredentialSetupRequestedConsumer {

    private static final Logger LOG = LoggerFactory.getLogger(AccountCredentialSetupRequestedConsumer.class);

    private final NotificationService notificationService;
    private final ProcessedEventStore processedEventStore;

    AccountCredentialSetupRequestedConsumer(
    ...
    void onCredentialSetupRequested(EventEnvelope<AccountCredentialSetupRequestedPayload> event) {
